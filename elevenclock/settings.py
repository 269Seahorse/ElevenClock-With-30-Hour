...
class SettingsUI(QMainWindow):
    ...
    {_("Now you should see the clock everywhere")}""")
        ...
        self.enable30HourClock = QSettingsCheckBox(_("Enable 30-hour clock") + " (30\u6642\u5236)" + " \u2014 " + _("Hours 0-5 shown as 24-29"))
        self.enable30HourClock.setChecked(self.getSettings("Enable30HourClock"))
        self.enable30HourClock.stateChanged.connect(lambda i: self.setSettings("Enable30HourClock", bool(i)))
        self.dateTimeTitle.addWidget(self.enable30HourClock)
